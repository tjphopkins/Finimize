...
describe('Interest Calculator Routes', () => {
    describe('/monthly-balances route', () => {
        it('without currency param returns successfully',
                (done) => {
            chai.request(app)
        ...
        it('with invalid param returns with error status code and message',
                (done) => {
            chai.request(app)
                .get('/api/interest-calc/monthly-balances')
                .query({
        ...
        it('with missing param returns with error status code and message',
                (done) => {
            chai.request(app)
                .get('/api/interest-calc/monthly-balances')
                .query({
        ...
        it('with currency param as USD returns successfully',
                (done) => {
            chai.request(app)
                .get('/api/interest-calc/monthly-balances')
                .query({
